                ...
                <div class="span9" id="content">
                            ...
                            <div class="navbar">
                                <div class="navbar-inner">
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="active">
                                            <a href="index.php">Difficulty Types</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left">Add Difficulty Types</div>
                            </div>
                                     ...
                                     <input type="hidden" name="id" value="<?php echo $id; ?>" >
                                      <fieldset>
                                        ...
                                        <div class="control-group">
                                          <label class="control-label" for="focusedInput">Difficulty Type</label>
                                             <div class="controls">
                                                <input type="text" name="difficultyName" class="span3 m-wrap" placeholder="Type of Difficulty" value="<?php echo $id ? $difficultyArray[$id]['Name'] : '';?>"/>
                                            </div>
                                        </div>
                                        <div class="control-group">
                    ...
                    <div class="row-fluid">
                        <!-- block -->
                            <div class="block">
                                <div class="navbar navbar-inner block-header">
                                    <div class="muted pull-left">Manage Difficulties</div>
                                    <div class="pull-right"><span class="badge badge-info"><?php echo count($difficultyArray); ?></span>
                                ...
                                <div class="block-content collapse in">
                                    <table class="table table-striped">
                                        ...
                                        <tbody>
                                        <?php foreach ($difficultyArray as $key => $value) {
                                        ?>                                            
                                            <tr>
                                                <td><?php echo $value['Name']; ?></td>
                                                <td><?php echo $value['IsActive']? 'Yes' : 'No'; ?></td>
                                                <td>
                                                    <a href="difficulty.php?id=<?php echo $value['DifficultyId']; ?>">
                                                    <img src="images/Edit.png" height="25px" width="25px"></a>
                                                </td>
                                                <td>
                                                    <a onclick="return checkDelete(<?php echo $value['DifficultyId']; ?>);" style="cursor: pointer;">
